...
export default function ServiceCard({
  ...
  return (
    <article className="relative mb-4 rounded-md border-2 border-grayDark-darker bg-woodTexture bg-cover p-4 shadow-lg">
      <div className="absolute inset-0 z-20 rounded-md bg-grayLight opacity-50"></div>
      <div className="relative z-30 opacity-100">
        <img
          src={serviceImgUrl}
          alt={serviceImgAlt}
          className="mb-4 rounded-md border-2 border-grayDark-darker shadow-lg"
        />
